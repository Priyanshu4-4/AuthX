  ...
  return (
    <div>
      <div className="mb-8 fade-up">
        ...
        <p className="text-slate-500 text-sm mt-1">Send ETH to your AuthX contract balance on Sepolia</p>
      </div>
          ...
          <div className="card space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                <span className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 text-sm font-medium">ETH</span>
              </div>
            </div>
            ...
            <div className="px-4 py-3 rounded-xl bg-blue-500/5 border border-blue-500/20 text-xs text-slate-400 space-y-1">
              ...
              <p>• Your wallet will sign the transaction directly</p>
